...
import { isStatusCode200, isStatusCode201, isStatusCode302, pageContentCheck } from '../../common/utils/checks/assertions'
...
export function getRedirect (): void {
  group('GET /redirect', () => {
    ...
    timeRequest(() => http.get(redirectUrl, {
      redirects: 0,
...
export function getAbortCommand (): void {
  group('GET /abortCommand', () => {
    ...
    timeRequest(() => http.get(abortCommandUrl, {
      redirects: 0,
