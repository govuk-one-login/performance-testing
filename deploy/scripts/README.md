...
2. Switch to the relevant Performance Tester role.
    ...
    |:-:|:-:|:-:|:-:|
    |Build|`301577035144`|`account-perf-tests-PerformanceTester`|[Switch role](https://signin.aws.amazon.com/switchrole?roleName=account-perf-tests-PerformanceTester&account=301577035144)|
    |Staging|`539729775994`|`account-perf-tests-PerformanceTester`|[Switch role](https://signin.aws.amazon.com/switchrole?roleName=account-perf-tests-PerformanceTesterr&account=539729775994)|
...
3. Go to the CodeBuild project and click 'Start build with overrides':
    ...
    - [Build link](https://eu-west-2.console.aws.amazon.com/codesuite/codebuild/301577035144/projects/LoadTest-account-perf-tests/builds/start?region=eu-west-2)
    - [Staging link](https://eu-west-2.console.aws.amazon.com/codesuite/codebuild/539729775994/projects/LoadTest-account-perf-tests/builds/start?region=eu-west-2)
...
4. Update environment variables in the 'Environment variables override' section. All environment variables are available in test scripts in the `__ENV` variable (see [k6 docs](https://k6.io/docs/using-k6/environment-variables/))
    ...
    |-|-|-|
    |`TEST_SCRIPT`|`test-accountManagement.js`</br>`test-data.js`</br>`test.js`<sup> [_default_]</sup></br>`unit-tests.js`|Relative path of test script to use, including `.js` extension|
